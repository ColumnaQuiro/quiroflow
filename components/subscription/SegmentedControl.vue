...
<template>
  <div
    ref="root"
    role="tablist"
    class="inline-flex gap-0.5 rounded-ctl bg-chip-bg p-[3px]"
    @keydown="onKeydown"
  >
    ...
    <button
      ...
      class="inline-flex h-8 touch:h-10 items-center whitespace-nowrap rounded-[7px] px-3 text-[13px] outline-none"
      :class="
        item.key === modelValue
