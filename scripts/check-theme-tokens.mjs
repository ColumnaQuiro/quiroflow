...
const ROOTS = ['components/AppSidebar.vue', 'components/growth', 'pages/growth', 'components/calendar', 'pages/calendar.vue', 'pages/account.vue', 'components/ui/ConfirmDialog.vue', 'pages/recalls.vue']
