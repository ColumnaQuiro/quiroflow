...
const ROOTS = ['pages/settings/clinics', 'components/settings/ClinicHoursEditor.vue', 'components/settings/TimeZonePicker.vue', 'components/AppSidebar.vue', 'components/growth', 'pages/growth', 'components/calendar', 'pages/calendar.vue', 'pages/account.vue', 'components/ui/ConfirmDialog.vue', 'pages/recalls.vue']
