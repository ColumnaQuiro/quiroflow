...
const ROOTS = ['components/settings/ClinicClosures.vue', 'pages/settings/clinics', 'pages/settings/appointment-types', 'components/settings/SwitchRow.vue', 'components/settings/ClinicHoursEditor.vue', 'components/settings/TimeZonePicker.vue', 'components/AppSidebar.vue', 'components/growth', 'pages/growth', 'components/calendar', 'pages/calendar.vue', 'pages/account.vue', 'components/ui/ConfirmDialog.vue', 'pages/recalls.vue']
