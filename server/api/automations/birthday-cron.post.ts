...
export default defineEventHandler(async (event) => {
  ...
  const { data: candidates } = await supabase
    .from('patients')
    .select('id, account_id, first_name, last_name, email, is_minor, do_not_contact, marketing_channels, date_of_birth, address, city, postal_code, country, national_id, occupation, gender, emergency_contact')
