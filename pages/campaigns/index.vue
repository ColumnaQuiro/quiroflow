...
const TRIGGER_LABELS: Record<string, string> = {
  ...
  'appointment.same_day': 'Day of appointment (morning send)',
...
const TRIGGER_DESCRIPTIONS: Record<string, string> = {
  ...
  'appointment.same_day': 'Runs once a day around 9am; fires for any booked appointment happening that day.',
