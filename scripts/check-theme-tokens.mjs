...
<<<<<<< HEAD
const ROOTS = ['components/settings/ClinicClosures.vue', 'pages/settings/roles', 'components/settings/RolePermissionRow.vue', 'components/reports/PractitionerClinicFilters.vue', 'pages/settings/clinics', 'components/settings/ClinicHoursEditor.vue', 'components/settings/TimeZonePicker.vue', 'components/AppSidebar.vue', 'components/growth', 'pages/growth', 'components/calendar', 'pages/calendar.vue', 'pages/account.vue', 'components/ui/ConfirmDialog.vue', 'pages/recalls.vue']
=======
const ROOTS = ['components/settings/ClinicClosures.vue', 'pages/settings/clinics', 'components/settings/ClinicHoursEditor.vue', 'components/settings/TimeZonePicker.vue', 'components/AppSidebar.vue', 'components/growth', 'pages/growth', 'components/calendar', 'pages/calendar.vue', 'pages/account.vue', 'components/ui/ConfirmDialog.vue', 'pages/recalls.vue', 'pages/settings/team', 'components/settings/InviteDialog.vue']
>>>>>>> origin/main
